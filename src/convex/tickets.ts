...
export const seedSampleTickets = mutation({
  ...
  handler: async (ctx) => {
    ...
    const samples: Sample[] = [
      {
        subject: "چرخش کلیدهای API محیط استیجینگ تا جمعه",
        requester: "امیر رضایی",
        email: "amir@example.com",
        body: "کلیدهای استیجینگ در سه جا پخش شده و یکی از آنها داخل یک نوت قدیمی است. میخواهم قبل از توقف انتشار، همه را عوض کنیم و در والت بگذاریم.",
        status: TICKET_STATUSES.OPEN,
      ...
      {
        subject: "راهنمای انتشار بهروز نیست",
        requester: "سحر کاظمی",
        email: "sahar@example.com",
        body: "با راهنمای انتشار جلو رفتم و به مرحلهای رسیدم که دیگر وجود ندارد. دیروز وسط حادثه بیست دقیقه وقتم رفت.",
        status: TICKET_STATUSES.OPEN,
      ...
      {
        subject: "ورود فایلهای بزرگتر از ۵ مگابایت انجام نمیشود",
        requester: "نگار محمدی",
        email: "negar@example.com",
        body: "ورود مخاطبان روی ۵ مگابایت بیصدا متوقف میشود. هیچ پیامی نشان داده نمیشود و فایل ۴.۸ مگابایتی بدون مشکل بالا میرود.",
        status: TICKET_STATUSES.PENDING,
        priority: TICKET_PRIORITIES.NORMAL,
        hoursAgo: 30,
        comment: {
          author: "نوید اکبری",
          body: "روی سیستم من هم همین اتفاق میافتد. بارگذار هر فایل بیشتر از ۵ مگابایت را با یک خطای کلی رد میکند. محدودیت را روی شاخهام به ۲۰ مگابایت رساندهام.",
          delayHours: 1.5,
        },
      },
      {
        subject: "نمودارها در سافاری سفید میمانند",
        requester: "سینا مرادی",
        email: "sina@example.com",
        body: "همه نمودارهای صفحه تحلیلها در سافاری ۱۷ بهصورت کادر خالی دیده میشوند، اما در کروم و فایرفاکس درست هستند.",
        status: TICKET_STATUSES.RESOLVED,
        priority: TICKET_PRIORITIES.NORMAL,
        hoursAgo: 96,
        comment: {
          author: "نگار محمدی",
          body: "مشکل از کتابخانه نمودار و سافاری بود. درست شد و منتشر شد؛ صفحه را با بازخوانی کامل باز کنید.",
          delayHours: 3,
        },
      },
      {
        subject: "چکلیست شروع کار را به هندبوک اضافه کنید",
        requester: "هدیه نوری",
        email: "hedieh@example.com",
        body: "اعضای جدید در هفته اول همیشه همان پنج سؤال را میپرسند. یک چکلیست نوشتهام و لازم است کسی قبل از انتشار بازبینی کند.",
        status: TICKET_STATUSES.PENDING,
        priority: TICKET_PRIORITIES.LOW,
        hoursAgo: 76,
        comment: {
          author: "الهام صادقی",
          body: "دو مورد درباره دسترسی استیجینگ و والت اضافه کردم. یک نگاه بیندازید تا منتشرش کنم.",
          delayHours: 5,
        },
      },
      {
        subject: "تست سرتاسری صورتحساب گاهی خطا میدهد و ادغام را متوقف میکند",
        requester: "کامران یوسفی",
        email: "kamran@example.com",
        body: "تست سرتاسری صورتحساب تقریباً یک بار از هر پنج اجرا شکست میخورد و همه تا سبز شدن، خط لوله را دوباره اجرا میکنند. دو هفته است همینطور است.",
        status: TICKET_STATUSES.OPEN,
        priority: TICKET_PRIORITIES.HIGH,
        hoursAgo: 52,
        ownedByViewer: true,
      ...
      {
        subject: "همگامسازی شبانه به محدودیت نرخ API میخورد",
        requester: "مریم شریفی",
        email: "maryam@example.com",
        body: "همگامسازی شبانه در میانه راه خطای ۴۲۹ میگیرد و روز بعد از ابتدا شروع میکند. یک هفته است که یک دور کامل تمام نشده.",
        status: TICKET_STATUSES.OPEN,
        priority: TICKET_PRIORITIES.URGENT,
        hoursAgo: 150,
      },
      {
        subject: "تلاش دوباره، محتوای قدیمی وبهوک را میفرستد",
        requester: "بهنام رستمی",
        email: "behnam@example.com",
        body: "وقتی تحویل ناموفق میشود، تلاش دوباره محتوای اولین ارسال را میفرستد نه آخرین وضعیت؛ در نتیجه مصرفکننده ما رویداد قدیمی را اعمال میکند.",
        status: TICKET_STATUSES.OPEN,
        priority: TICKET_PRIORITIES.HIGH,
        hoursAgo: 240,
      },
      {
        subject: "بازنشانی شبانه به یک باکت جداگانه منتقل شود",
        requester: "الهام صادقی",
        email: "elham@example.com",
        body: "فعلاً پشتیبانها در همان باکتی قرار میگیرند که فایلهای کاربران در آن است. ترجیح میدهم جدا شوند و قاعده نگهداری مخصوص خودشان را داشته باشند.",
        status: TICKET_STATUSES.CLOSED,
        priority: TICKET_PRIORITIES.LOW,
        hoursAgo: 300,
        comment: {
          author: "امیر رضایی",
          body: "به باکت پشتیبان با قاعده نگهداری ۹۰ روزه منتقل شد. این را میبندم؛ اگر بعد از اجرای بعدی مشکلی دیدید بازش کنید.",
          delayHours: 8,
        },
      },
      {
        subject: "گزارش حادثه را بنویسید",
        requester: "نوید اکبری",
        email: "navid@example.com",
        body: "قرار شد برای قطعی روز پنجشنبه یک گزارش بنویسیم. پیشنویس تا جلسه برنامهریزی بعدی لازم است.",
        status: TICKET_STATUSES.RESOLVED,
        priority: TICKET_PRIORITIES.NORMAL,
        hoursAgo: 120,
        comment: {
          author: "سینا مرادی",
          body: "پیشنویس با خط زمانی و سه تیکت پیگیری در ویکی داخلی آماده است. برای بازبینی شماست.",
          delayHours: 2,
        },
      },
    ];
