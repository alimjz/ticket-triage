...
import { ArrowRight, Loader2, Mail, SquareStack, UserX } from "lucide-react";
...
function Auth({ redirectAfterAuth }: AuthProps = {}) {
  ...
  const handleEmailSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setError(
        error instanceof Error ? error.message : t("auth.sendFailed"),
      );
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="relative flex min-h-screen flex-col bg-secondary/35">
